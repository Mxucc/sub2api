...
func init() {
	...
	// usagelogDescMatchedTier is the schema descriptor for matched_tier field.
	usagelogDescMatchedTier := usagelogFields[29].Descriptor()
	// usagelog.DefaultMatchedTier holds the default value on creation for the matched_tier field.
	usagelog.DefaultMatchedTier = usagelogDescMatchedTier.Default.(string)
	// usagelogDescBillingExprApplied is the schema descriptor for billing_expr_applied field.
	usagelogDescBillingExprApplied := usagelogFields[30].Descriptor()
	// usagelog.DefaultBillingExprApplied holds the default value on creation for the billing_expr_applied field.
	usagelog.DefaultBillingExprApplied = usagelogDescBillingExprApplied.Default.(bool)
