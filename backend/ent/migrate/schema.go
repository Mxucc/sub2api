...
var (
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "matched_tier", Type: field.TypeString, Default: "", SchemaType: map[string]string{"postgres": "varchar(32)"}},
		{Name: "billing_expr_applied", Type: field.TypeBool, Default: false},
