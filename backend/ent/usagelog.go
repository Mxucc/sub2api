...
type UsageLog struct {
	...
	// Billing-expression tier() name matched for this request; empty when not expression-billed
	MatchedTier string `json:"matched_tier,omitempty"`
	// Whether this request was priced by a declarative billing expression
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldImageSizeBreakdown:
			values[i] = new([]byte)
		case usagelog.FieldUpstreamModelMismatch, usagelog.FieldLongContextBillingApplied, usagelog.FieldBillingExprApplied, usagelog.FieldStream, usagelog.FieldCacheTTLOverridden:
		...
		case usagelog.FieldRequestID, usagelog.FieldModel, usagelog.FieldRequestedModel, usagelog.FieldUpstreamModel, usagelog.FieldUpstreamResponseModel, usagelog.FieldModelMappingChain, usagelog.FieldBillingTier, usagelog.FieldBillingMode, usagelog.FieldMatchedTier, usagelog.FieldUserAgent, usagelog.FieldIPAddress, usagelog.FieldImageSize, usagelog.FieldImageInputSize, usagelog.FieldImageOutputSize, usagelog.FieldImageSizeSource, usagelog.FieldVideoResolution:
...
func (_m *UsageLog) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usagelog.FieldMatchedTier:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field matched_tier", values[i])
			} else if value.Valid {
				_m.MatchedTier = value.String
			}
		case usagelog.FieldBillingExprApplied:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field billing_expr_applied", values[i])
			} else if value.Valid {
				_m.BillingExprApplied = value.Bool
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("matched_tier=")
	builder.WriteString(_m.MatchedTier)
	builder.WriteString(", ")
	builder.WriteString("billing_expr_applied=")
	builder.WriteString(fmt.Sprintf("%v", _m.BillingExprApplied))
	builder.WriteString(", ")
