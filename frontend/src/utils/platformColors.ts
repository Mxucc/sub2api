...
const BADGE: Record<Platform, string> = {
  ...
  openai: 'bg-sky-500/10 text-sky-700 border-sky-500/30 dark:text-sky-400',
  ...
  deepseek: 'bg-primary-500/10 text-primary-600 border-primary-500/30 dark:text-primary-300',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  openai: 'bg-sky-500/10 text-sky-700 dark:bg-sky-400/10 dark:text-sky-400',
  ...
  deepseek: 'bg-primary-500/10 text-primary-600 dark:bg-primary-500/10 dark:text-primary-300',
...
const BORDER: Record<Platform, string> = {
  ...
  openai: 'border-sky-500/20 dark:border-sky-400/20',
  ...
  deepseek: 'border-primary-500/20 dark:border-primary-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  openai: 'border-sky-500/35 dark:border-sky-400/30',
  ...
  deepseek: 'border-primary-500/35 dark:border-primary-500/30',
...
const ACCENT: Record<Platform, string> = {
  ...
  deepseek: '#0052d9', // brand blue
  minimax: '#f43f5e', // rose-500
  opencode_go: '#f59e0b', // amber-500
  composite: '#06b6d4', // cyan-500
}
const ACCENT_DEFAULT = '#0052d9' // primary-500 (brand blue)

// ── Accent bar (gradient) ───────────────────────────────────────────
const ACCENT_BAR: Record<Platform, string> = {
  anthropic: 'bg-gradient-to-r from-orange-400 to-orange-500',
  openai: 'bg-gradient-to-r from-sky-400 to-sky-500',
  ...
  deepseek: 'bg-gradient-to-r from-primary-400 to-primary-500',
...
const TEXT: Record<Platform, string> = {
  ...
  deepseek: 'text-primary-600 dark:text-primary-300',
...
const ICON: Record<Platform, string> = {
  ...
  openai: 'text-sky-500 dark:text-sky-400',
  ...
  deepseek: 'text-primary-500 dark:text-primary-300',
...
const BUTTON: Record<Platform, string> = {
  ...
  openai: 'bg-sky-700 text-white hover:bg-sky-800 active:bg-sky-900 dark:bg-sky-600 dark:hover:bg-sky-500',
  ...
  deepseek: 'bg-primary-500 text-white hover:bg-primary-600 active:bg-primary-700 dark:bg-primary-500/80 dark:hover:bg-primary-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  openai: 'bg-sky-100 text-sky-700 dark:bg-sky-900/40 dark:text-sky-400',
  ...
  deepseek: 'bg-primary-100 text-primary-700 dark:bg-primary-900/40 dark:text-primary-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  openai: 'from-sky-500 to-sky-700',
  ...
  deepseek: 'from-primary-500 to-primary-600',
