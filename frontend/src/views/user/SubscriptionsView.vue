          ...
          <div class="space-y-4 p-4">
            ...
            <div
              v-if="
                ...
                !subscription.group?.monthly_limit_usd
              "
              class="flex items-center justify-center rounded-xl bg-primary-50 py-6 dark:bg-primary-400/10"
            >
              <div class="flex items-center gap-3">
                <span class="text-4xl text-primary-700 dark:text-primary-400">∞</span>
                <div>
