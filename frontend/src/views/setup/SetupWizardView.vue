      ...
      <div class="card p-8">
        ...
        <div v-if="currentStep === 0" class="space-y-6">
          ...
          >
            ...
            <Icon v-else-if="dbConnected" name="check" size="md" class="mr-2 text-emerald-500" :stroke-width="2" />
            {{
              testingDb
        ...
        <div
          v-if="installSuccess"
          class="mt-6 rounded-xl border border-emerald-200 bg-emerald-50 p-4 dark:border-emerald-500/25 dark:bg-emerald-500/10"
        >
          <div class="flex items-start gap-3">
            <svg
              v-if="!serviceReady"
              class="h-5 w-5 flex-shrink-0 animate-spin text-emerald-500"
              fill="none"
              viewBox="0 0 24 24"
            >
              <circle
            ...
            <Icon v-else name="checkCircle" size="md" class="flex-shrink-0 text-emerald-500" />
            <div>
