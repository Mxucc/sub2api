<template>
  <AppLayout>
    <div class="space-y-6">
      ...
      <div
        class="border border-primary-200 bg-primary-50 px-4 py-3 text-sm text-primary-800 dark:border-primary-500/25 dark:bg-primary-500/15 dark:text-primary-200"
      >
