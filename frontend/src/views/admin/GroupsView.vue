          ...
          >
            ...
            <div class="relative" ref="columnDropdownRef">
              ...
              <div
                ...
                class="absolute right-0 top-full z-50 mt-1 max-h-80 w-48 overflow-y-auto rounded-lg border border-gray-200 bg-white py-1 shadow-popover dark:border-dark-600 dark:bg-dark-800"
              >
                <button
          ...
          <template #cell-account_count="{ row }">
            <div class="space-y-0.5 text-xs">
              <div>
                ...
                <span
                  class="ml-1 font-medium text-primary-700 dark:text-primary-400"
        ...
        <div v-if="!authStore.isSimpleMode && copyAccountsGroupOptions.length > 0">
          <div class="mb-1.5 flex items-center gap-1">
            ...
            <div class="group relative inline-flex">
              ...
              />
              <div
                class="pointer-events-none absolute bottom-full left-0 z-50 mb-2 w-72 opacity-0 transition-opacity duration-200 group-hover:pointer-events-auto group-hover:opacity-100"
              >
                <div
                  class="rounded-lg bg-gray-900 p-3 text-white shadow-popover dark:bg-gray-800"
                >
              ...
              <div class="p-4 bg-gray-50/30 dark:bg-dark-800/30">
                ...
                <div v-else class="space-y-3">
                  <div
                    ...
                    class="group relative rounded-xl border border-gray-200 bg-white p-4 shadow-sm transition-colors hover:border-primary-300 hover:shadow-card dark:border-dark-600 dark:bg-dark-700 dark:hover:border-primary-700"
                  >
                  ...
                  <button
                    type="button"
                    @click="addCreateMessagesDispatchMapping"
                    class="flex w-full items-center justify-center gap-2 rounded-xl border-2 border-dashed border-gray-300 bg-white py-3 text-sm font-medium text-gray-500 transition-colors hover:border-primary-300 hover:bg-primary-50/50 hover:text-primary-600 dark:border-dark-600 dark:bg-dark-800 dark:text-gray-400 dark:hover:border-primary-800 dark:hover:bg-primary-900/20 dark:hover:text-primary-400"
                  >
                    <Icon name="plus" size="sm" />
                    {{ t("admin.groups.openaiMessages.addExactMapping") }}
                  </button>
        ...
        <div v-if="createForm.platform === 'anthropic'" class="border-t pt-4">
          <div class="mb-1.5 flex items-center gap-1">
            ...
            <div class="group relative inline-flex">
              ...
              />
              <div
                class="pointer-events-none absolute bottom-full left-0 z-50 mb-2 w-80 opacity-0 transition-opacity duration-200 group-hover:pointer-events-auto group-hover:opacity-100"
              >
                <div
                  class="rounded-lg bg-gray-900 p-3 text-white shadow-popover dark:bg-gray-800"
                >
                      ...
                      <div
                        v-if="
                          ...
                          accountSearchResults[getCreateRuleSearchKey(rule)]
                            ?.length > 0
                        "
                        class="absolute z-50 mt-1 max-h-48 w-full overflow-auto rounded-lg border bg-white shadow-popover dark:border-dark-600 dark:bg-dark-800"
                      >
                        <button
      ...
      <div class="space-y-4">
        ...
        >
          <div
            ...
            :key="group.id"
            class="flex cursor-grab items-center gap-3 rounded-lg border border-gray-200 bg-white p-3 transition-shadow hover:shadow-card active:cursor-grabbing dark:border-dark-600 dark:bg-dark-700"
          >
