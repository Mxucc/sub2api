  ...
  <AppLayout>
    <TablePageLayout>
      ...
      <template #filters>
        ...
        <div class="filter-bar flex flex-wrap items-start justify-between gap-4">
          ...
          <template #cell-usage="{ row }">
            <div class="min-w-[280px] space-y-2">
              ...
              <div
                ...
                "
                class="flex items-center gap-2 rounded-lg bg-gradient-to-r from-emerald-50 to-primary-50 px-3 py-2 dark:from-emerald-500/10 dark:to-primary-500/10"
              >
          ...
          <template #cell-actions="{ row }">
            <div class="flex items-center gap-1">
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-colors hover:bg-primary-50 hover:text-primary-600 dark:hover:bg-primary-500/15 dark:hover:text-primary-300"
              >
              ...
              <button
                ...
                class="flex flex-col items-center gap-0.5 rounded-lg p-1.5 text-gray-500 transition-colors hover:bg-emerald-50 hover:text-emerald-600 dark:hover:bg-emerald-500/15 dark:hover:text-emerald-400"
              >
                <Icon name="refresh" size="sm" />
      ...
      <transition name="modal">
        <div v-if="showGuideModal" class="fixed inset-0 z-50 flex items-center justify-center p-4" @mousedown.self="showGuideModal = false">
          ...
          <div class="relative max-h-[85vh] w-full max-w-2xl overflow-y-auto rounded-xl bg-white p-6 shadow-2xl dark:bg-dark-800">
            ...
            <!-- Tip -->
            <div class="rounded-lg bg-primary-50 p-3 text-xs text-primary-700 dark:bg-primary-500/15 dark:text-primary-300">
...
.reset-info {
  @apply flex items-center gap-1 pl-12 text-[10px] text-primary-600 dark:text-primary-300;
}
</style>
