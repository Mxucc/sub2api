...
const healthScoreColor = computed(() => {
  ...
  if (score >= 90) return '#0a80bb' // primary-400
...
const dbMiddleClass = computed(() => {
  ...
  if (systemMetrics.value?.db_ok === true) return 'text-primary-700 dark:text-primary-400'
...
const redisMiddleClass = computed(() => {
  ...
  if (systemMetrics.value?.redis_ok === true) return 'text-primary-700 dark:text-primary-400'
  return 'text-gray-900 dark:text-white'
})
    ...
    <div class="flex flex-wrap items-center justify-between gap-4 border-b border-gray-100 pb-4 dark:border-dark-700">
      ...
      <div class="flex flex-wrap items-center gap-3">
        ...
        <button
          v-if="!props.fullscreen"
          type="button"
          class="flex h-8 items-center gap-1.5 rounded-lg bg-primary-100 px-3 text-xs font-bold text-primary-700 transition-colors hover:bg-primary-200 dark:bg-primary-500/15 dark:text-primary-300 dark:hover:bg-primary-500/15"
                ...
                <div class="space-y-3">
                  <div v-for="(item, idx) in diagnosisReport" :key="idx" class="flex gap-3">
                    ...
                    <div class="flex-1">
                      ...
                      <div v-if="item.action" class="mt-1 text-[11px] text-primary-600 dark:text-primary-300 flex items-center gap-1">
