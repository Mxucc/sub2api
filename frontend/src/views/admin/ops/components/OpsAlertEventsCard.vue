...
function severityBadgeClass(severity: string | undefined): string {
  ...
  if (s === 'p2' || s === 'info') return 'bg-primary-100 text-primary-700 dark:bg-primary-500/15 dark:text-primary-300'
...
function statusBadgeClass(status: string | undefined): string {
  ...
  if (s === 'resolved') return 'bg-primary-50 text-primary-700 ring-primary-700/20 dark:bg-primary-900/30 dark:text-primary-400 dark:ring-primary-400/30'
