            ...
            <table class="w-full text-xs">
              ...
              <tbody>
                <tr v-for="model in models" :key="model.model" class="border-t border-gray-100 dark:border-dark-700">
                  ...
                  <td class="py-1.5 text-right text-primary-700 dark:text-primary-400">${{ formatCost(model.actual_cost) }}</td>
...
const modelData = computed(() => !props.models?.length ? null : {
  ...
  datasets: [{
    ...
    backgroundColor: ['#08699a', '#0a80bb', '#f59e0b', '#ef4444', '#8b5cf6', '#ec4899', '#06b6d4', '#22d3ee']
  }]
})
