  ...
  <div>
        ...
        <div class="max-h-52 overflow-auto">
          ...
          >
            ...
            <button
              ...
              class="mr-2 rounded p-1.5 text-gray-400 opacity-70 transition-colors hover:bg-gray-200 hover:text-primary-600 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 group-hover:opacity-100 dark:text-gray-500 dark:hover:bg-dark-700 dark:hover:text-primary-400"
    ...
    <div class="mb-4 flex flex-wrap gap-2">
      <button
        type="button"
        @click="fillRelated"
        class="rounded-lg border border-primary-200 px-3 py-1.5 text-sm text-primary-600 hover:bg-primary-50 dark:border-primary-500/25 dark:text-primary-300 dark:hover:bg-primary-500/15"
      >
