<template>
  ...
  >
    <div class="space-y-6">
      ...
      <div
        v-if="account"
        class="flex items-center justify-between rounded-xl border border-primary-200 bg-primary-50 p-3 dark:border-primary-700/50 dark:bg-primary-500/10"
      >
      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <!-- 30-Day Total Cost -->
          <div
            class="card border-primary-200 bg-primary-50 p-4 dark:border-primary-800/30 dark:bg-primary-400/10"
          >
          ...
          <div
            class="card border-primary-200 bg-primary-50 p-4 dark:border-primary-500/25 dark:bg-primary-500/10"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-gray-500 dark:text-gray-400">{{
                t('admin.accounts.stats.totalRequests')
              }}</span>
              <div class="rounded-lg bg-primary-100 p-1.5 dark:bg-primary-500/15">
                <Icon name="bolt" size="sm" class="text-primary-600 dark:text-primary-300" :stroke-width="2" />
              </div>
            </div>
            <p class="text-2xl font-bold text-gray-900 dark:text-white">
          ...
          <!-- Daily Average Cost -->
          <div
            class="card border-amber-200 bg-amber-50 p-4 dark:border-amber-800/30 dark:bg-amber-500/10"
          >
            <div class="mb-2 flex items-center justify-between">
              <span class="text-xs font-medium text-gray-500 dark:text-gray-400">{{
    ...
    <template #footer>
      <div class="flex justify-end">
        <button
          @click="handleClose"
          class="rounded-lg bg-gray-100 px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200 dark:bg-dark-600 dark:text-gray-300 dark:hover:bg-dark-700"
        >
          {{ t('common.close') }}
        </button>
      </div>
