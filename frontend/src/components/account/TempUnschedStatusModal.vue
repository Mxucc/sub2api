  ...
  >
    <div class="space-y-4">
      ...
      <div v-else class="space-y-4">
        <div class="rounded-lg border border-primary-200 bg-primary-50 p-3 text-sm text-primary-800 dark:border-primary-400/30 dark:bg-primary-400/10 dark:text-primary-400">
