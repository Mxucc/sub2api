          ...
          <button
            ...
            :class="[
              ...
              accountCategory === 'oauth-based'
                ...
                : 'border-gray-200 hover:border-primary-300 dark:border-dark-600 dark:hover:border-primary-400'
            ]"
          >
            <div
              :class="[
            ...
            >
              ...
              <div class="min-w-0">
                ...
                <div class="mt-2 flex flex-wrap gap-1">
                  ...
                  <span
                    class="rounded bg-primary-100 px-2 py-0.5 text-[10px] font-semibold text-primary-700 dark:bg-primary-900/40 dark:text-primary-400"
                  >
