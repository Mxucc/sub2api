<template>
  <header
    class="sticky top-0 z-30 border-b border-gray-200/80 bg-white/90 backdrop-blur-xl dark:border-dark-800 dark:bg-dark-950/90"
  >
    <div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3.5 sm:px-6">
      ...
      <div class="flex min-w-0 items-center gap-3">
        <template v-if="settings">
          <span
            class="flex h-9 w-9 flex-shrink-0 items-center justify-center overflow-hidden rounded-xl bg-primary-50 ring-1 ring-gray-200/80 dark:bg-primary-500/10 dark:ring-dark-700/80"
          >
        ...
        <template v-else>
          <span class="skeleton h-9 w-9 flex-shrink-0 rounded-xl" aria-hidden="true"></span>
