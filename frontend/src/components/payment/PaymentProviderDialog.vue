  ...
  >
    <form id="provider-form" @submit.prevent="handleSave" class="space-y-4">
      ...
      <div class="border-t border-gray-200 pt-4 dark:border-dark-700">
        ...
        <!-- 服务商 Webhook 提示 -->
        <div v-if="providerWebhookUrl" class="mt-3 rounded-lg border border-primary-200 bg-primary-50 p-3 dark:border-primary-500/25 dark:bg-primary-500/15">
          <p class="text-xs text-primary-700 dark:text-primary-300">
            {{ t(providerWebhookHint) }}
          </p>
          <code class="mt-1 block break-all rounded bg-primary-100 px-2 py-1 text-xs text-primary-800 dark:bg-primary-500/15 dark:text-primary-200">
            {{ providerWebhookUrl }}
          </code>
