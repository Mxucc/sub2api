...
const statusMap: Record<OrderStatus, { key: string; class: string }> = {
  ...
  COMPLETED: { key: 'payment.status.completed', class: 'bg-primary-100 text-primary-800 dark:bg-primary-900/30 dark:text-primary-400' },
  ...
  REFUNDED: { key: 'payment.status.refunded', class: 'bg-primary-100 text-primary-800 dark:bg-primary-500/15 dark:text-primary-300' },
  PARTIALLY_REFUNDED: { key: 'payment.status.partially_refunded', class: 'bg-primary-100 text-primary-800 dark:bg-primary-500/15 dark:text-primary-300' },
