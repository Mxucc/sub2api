            ...
            <template v-for="group in displayGroupStats" :key="group.group_id">
              ...
              >
                <td
                  ...
                  :class="enableBreakdown && group.group_id > 0 ? 'text-primary-600 hover:text-primary-800 dark:text-primary-300 dark:hover:text-primary-300' : 'text-gray-900 dark:text-white'"
