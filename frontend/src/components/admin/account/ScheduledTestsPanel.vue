      ...
      >
        ...
        <div class="mt-3 flex justify-end gap-2">
          <button
            ...
            class="rounded-lg bg-gray-100 px-3 py-1.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-200 dark:bg-dark-600 dark:text-gray-300 dark:hover:bg-dark-700"
          >
            {{ t('common.cancel') }}
          </button>
          <button
      ...
      <div v-else class="space-y-3">
        ...
        >
          ...
          >
            <div class="flex flex-1 items-center gap-4">
              ...
              <span
                ...
                class="inline-flex items-center rounded-full bg-primary-100 px-2 py-0.5 text-xs font-medium text-primary-700 dark:bg-primary-400/20 dark:text-primary-400"
              >
                {{ t('admin.scheduledTests.autoRecover') }}
              </span>
            </div>
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="flex items-center gap-1" @click.stop>
                <button
                  ...
                  class="rounded-lg p-1.5 text-gray-400 transition-colors hover:bg-primary-50 hover:text-primary-500 dark:hover:bg-primary-500/15"
          ...
          <div
            ...
            class="border-t border-primary-100 bg-primary-50/50 px-4 py-3 dark:border-primary-500/25 dark:bg-primary-500/10"
            @click.stop
          >
