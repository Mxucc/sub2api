...
export function getPlatformTagClass(platform: string): string {
  switch (platform) {
    ...
    case 'openai': return 'bg-primary-100 text-primary-700 dark:bg-primary-900/30 dark:text-primary-400'
    ...
    case 'deepseek': return 'bg-primary-50 text-primary-600 dark:bg-primary-500/10 dark:text-primary-300'
...
export function getPlatformTextClass(platform: string): string {
  switch (platform) {
    ...
    case 'openai': return 'text-primary-700 dark:text-primary-400'
    ...
    case 'deepseek': return 'text-primary-600 dark:text-primary-300'
    default: return ''
  }
}
