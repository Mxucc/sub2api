<template>
  ...
  >
    ...
    <div v-else class="space-y-4">
      ...
      <div v-if="form.provider === PROVIDER_OPENAI" class="rounded-lg border border-primary-100 bg-primary-50/50 p-3 dark:border-primary-500/25 dark:bg-primary-500/10">
