export default {
  ...
  modelPlaza: {
    ...
    table: {
      ...
      perRequest: 'Per request',
      perImage: 'Per image',
      // Billing-expression tiers (billing_expr): the official column is only a baseline
      timeTierTitleTime: 'Time-based pricing',
      timeTierTitleTiers: 'Tiered pricing',
      timeTierCaption: 'Unit prices for {model}',
      timeTierUnitPerMillion: '$ / 1M',
      timeTierExpand: 'Show',
      timeTierCollapse: 'Hide',
      timeTierTierColumn: 'Period / Tier',
      timeTierConditionColumn: 'Applies when',
      timeTierFlatColumn: 'Per request',
      timeTierFlatUnit: '$ / request',
      timeTierUnconditional: 'All other times',
      timeTierUnnamedTier: 'Tier {index}',
      timeTierNamePeak: 'Peak',
      timeTierNameOffPeak: 'Off-peak',
      timeTierNameBase: 'Standard',
      timeTierSourceCatalog: 'Price table',
      timeTierSourceBuiltin: 'Built-in',
      timeTierBaselineBadge: 'baseline',
      timeTierBaselineNote: 'The official price column is a baseline only and excludes time-of-day differences; each model’s actual unit prices are listed in its tier table',
      timeTierUnitNote: 'Tier prices are official rates per 1M tokens, excluding group rates',
      timeTierRawNote: 'This model is billed by an expression that is not a recognisable time-tier form; the raw expression is shown below',
      varInput: 'Input',
      varOutput: 'Output',
      varCacheRead: 'Cache hit',
      varCacheWrite: 'Cache write',
      varCacheWrite1h: 'Cache write (1h)',
      varImageInput: 'Image input',
      varImageCacheRead: 'Image cache hit',
      varAudioInput: 'Audio input',
      varAudioOutput: 'Audio output'
    },
    nav: {
      login: 'Sign In',
